...
import {AltSettingKeyboard, MainSettingKeyboard, SettingKeyboard} from "#app/system/settings-keyboard";
...
const cfg_keyboard_azerty = {
    ...
    settings: {
        [MainSettingKeyboard.Button_Up]: Button.UP,
        [MainSettingKeyboard.Button_Down]: Button.DOWN,
        [MainSettingKeyboard.Button_Left]: Button.LEFT,
        [MainSettingKeyboard.Button_Right]: Button.RIGHT,
        [MainSettingKeyboard.Button_Submit]: Button.SUBMIT,
        [MainSettingKeyboard.Button_Action]: Button.ACTION,
        [MainSettingKeyboard.Button_Cancel]: Button.CANCEL,
        [MainSettingKeyboard.Button_Menu]: Button.MENU,
        [MainSettingKeyboard.Button_Stats]: Button.STATS,
        [MainSettingKeyboard.Button_Cycle_Shiny]: Button.CYCLE_SHINY,
        [MainSettingKeyboard.Button_Cycle_Form]: Button.CYCLE_FORM,
        [MainSettingKeyboard.Button_Cycle_Gender]: Button.CYCLE_GENDER,
        [MainSettingKeyboard.Button_Cycle_Ability]: Button.CYCLE_ABILITY,
        [MainSettingKeyboard.Button_Cycle_Nature]: Button.CYCLE_NATURE,
        [MainSettingKeyboard.Button_Cycle_Variant]: Button.CYCLE_VARIANT,
        [MainSettingKeyboard.Button_Speed_Up]: Button.SPEED_UP,
        [MainSettingKeyboard.Button_Slow_Down]: Button.SLOW_DOWN,
        [AltSettingKeyboard.Alt_Button_Up]: Button.UP,
        [AltSettingKeyboard.Alt_Button_Down]: Button.DOWN,
        [AltSettingKeyboard.Alt_Button_Left]: Button.LEFT,
        [AltSettingKeyboard.Alt_Button_Right]: Button.RIGHT,
        [AltSettingKeyboard.Alt_Button_Submit]: Button.SUBMIT,
        [AltSettingKeyboard.Alt_Button_Action]: Button.ACTION,
        [AltSettingKeyboard.Alt_Button_Cancel]: Button.CANCEL,
        [AltSettingKeyboard.Alt_Button_Menu]: Button.MENU,
        [AltSettingKeyboard.Alt_Button_Stats]: Button.STATS,
        [AltSettingKeyboard.Alt_Button_Cycle_Shiny]: Button.CYCLE_SHINY,
        [AltSettingKeyboard.Alt_Button_Cycle_Form]: Button.CYCLE_FORM,
        [AltSettingKeyboard.Alt_Button_Cycle_Gender]: Button.CYCLE_GENDER,
        [AltSettingKeyboard.Alt_Button_Cycle_Ability]: Button.CYCLE_ABILITY,
        [AltSettingKeyboard.Alt_Button_Cycle_Nature]: Button.CYCLE_NATURE,
        [AltSettingKeyboard.Alt_Button_Cycle_Variant]: Button.CYCLE_VARIANT,
        [AltSettingKeyboard.Alt_Button_Speed_Up]: Button.SPEED_UP,
        [AltSettingKeyboard.Alt_Button_Slow_Down]: Button.SLOW_DOWN,
    },
    default: {
        KEY_ARROW_UP: MainSettingKeyboard.Button_Up,
        KEY_ARROW_DOWN: MainSettingKeyboard.Button_Down,
        KEY_ARROW_LEFT: MainSettingKeyboard.Button_Left,
        KEY_ARROW_RIGHT: MainSettingKeyboard.Button_Right,
        KEY_ENTER: MainSettingKeyboard.Button_Submit,
        KEY_SPACE: MainSettingKeyboard.Button_Action,
        KEY_BACKSPACE: MainSettingKeyboard.Button_Cancel,
        KEY_ESC: MainSettingKeyboard.Button_Menu,
        KEY_C: MainSettingKeyboard.Button_Stats,
        KEY_R: MainSettingKeyboard.Button_Cycle_Shiny,
        KEY_F: MainSettingKeyboard.Button_Cycle_Form,
        KEY_G: MainSettingKeyboard.Button_Cycle_Gender,
        KEY_E: MainSettingKeyboard.Button_Cycle_Ability,
        KEY_N: MainSettingKeyboard.Button_Cycle_Nature,
        KEY_V: MainSettingKeyboard.Button_Cycle_Variant,
        KEY_PLUS: MainSettingKeyboard.Button_Speed_Up,
        KEY_MINUS: MainSettingKeyboard.Button_Slow_Down,
        KEY_A: -1,
        KEY_B: -1,
        KEY_D: AltSettingKeyboard.Alt_Button_Right,
        KEY_H: -1,
        KEY_I: AltSettingKeyboard.Alt_Button_Cycle_Nature,
        KEY_J: -1,
        KEY_K: AltSettingKeyboard.Alt_Button_Cycle_Variant,
        KEY_L: AltSettingKeyboard.Alt_Button_Cycle_Ability,
        KEY_M: AltSettingKeyboard.Alt_Button_Cycle_Form,
        KEY_O: AltSettingKeyboard.Alt_Button_Cycle_Gender,
        KEY_P: AltSettingKeyboard.Alt_Button_Cycle_Shiny,
        KEY_Q: AltSettingKeyboard.Alt_Button_Left,
        KEY_S: AltSettingKeyboard.Alt_Button_Down,
        KEY_T: -1,
        KEY_U: -1,
        KEY_W: AltSettingKeyboard.Alt_Button_Action,
        KEY_X: AltSettingKeyboard.Alt_Button_Cancel,
        KEY_Y: -1,
        KEY_Z: AltSettingKeyboard.Alt_Button_Up,
        KEY_0: -1,
        KEY_1: -1,
        KEY_2: -1,
        KEY_3: -1,
        ...
        KEY_8: -1,
        KEY_9: -1,
        KEY_CTRL: AltSettingKeyboard.Alt_Button_Submit,
        KEY_DEL: -1,
        KEY_END: -1,
        KEY_F1: -1,
        KEY_F2: -1,
        ...
        KEY_HOME: -1,
        KEY_INSERT: -1,
        KEY_PAGE_DOWN: AltSettingKeyboard.Alt_Button_Slow_Down,
        KEY_PAGE_UP: AltSettingKeyboard.Alt_Button_Speed_Up,
        KEY_QUOTATION: -1,
        KEY_SHIFT: AltSettingKeyboard.Alt_Button_Stats,
        KEY_TAB: AltSettingKeyboard.Alt_Button_Menu,
        KEY_TILDE: -1,
        KEY_LEFT_BRACKET: -1,
        KEY_RIGHT_BRACKET: -1,
        KEY_SEMICOLON: -1,
