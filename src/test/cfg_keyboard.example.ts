...
const cfg_keyboard_azerty = {
    ...
    settings: {
        [SettingInterfaceKeyboard.Button_Up]: Button.UP,
        [SettingInterfaceKeyboard.Button_Down]: Button.DOWN,
        [SettingInterfaceKeyboard.Button_Left]: Button.LEFT,
        [SettingInterfaceKeyboard.Button_Right]: Button.RIGHT,
        [SettingInterfaceKeyboard.Button_Submit]: Button.SUBMIT,
        [SettingInterfaceKeyboard.Button_Action]: Button.ACTION,
        [SettingInterfaceKeyboard.Button_Cancel]: Button.CANCEL,
        [SettingInterfaceKeyboard.Button_Menu]: Button.MENU,
        [SettingInterfaceKeyboard.Button_Stats]: Button.STATS,
        [SettingInterfaceKeyboard.Button_Cycle_Shiny]: Button.CYCLE_SHINY,
        [SettingInterfaceKeyboard.Button_Cycle_Form]: Button.CYCLE_FORM,
        [SettingInterfaceKeyboard.Button_Cycle_Gender]: Button.CYCLE_GENDER,
        [SettingInterfaceKeyboard.Button_Cycle_Ability]: Button.CYCLE_ABILITY,
        [SettingInterfaceKeyboard.Button_Cycle_Nature]: Button.CYCLE_NATURE,
        [SettingInterfaceKeyboard.Button_Cycle_Variant]: Button.CYCLE_VARIANT,
        [SettingInterfaceKeyboard.Button_Speed_Up]: Button.SPEED_UP,
        [SettingInterfaceKeyboard.Button_Slow_Down]: Button.SLOW_DOWN,
        [SettingInterfaceKeyboard.Alt_Button_Up]: Button.UP,
        [SettingInterfaceKeyboard.Alt_Button_Down]: Button.DOWN,
        [SettingInterfaceKeyboard.Alt_Button_Left]: Button.LEFT,
        [SettingInterfaceKeyboard.Alt_Button_Right]: Button.RIGHT,
        [SettingInterfaceKeyboard.Alt_Button_Submit]: Button.SUBMIT,
        [SettingInterfaceKeyboard.Alt_Button_Action]: Button.ACTION,
        [SettingInterfaceKeyboard.Alt_Button_Cancel]: Button.CANCEL,
        [SettingInterfaceKeyboard.Alt_Button_Menu]: Button.MENU,
        [SettingInterfaceKeyboard.Alt_Button_Stats]: Button.STATS,
        [SettingInterfaceKeyboard.Alt_Button_Cycle_Shiny]: Button.CYCLE_SHINY,
        [SettingInterfaceKeyboard.Alt_Button_Cycle_Form]: Button.CYCLE_FORM,
        [SettingInterfaceKeyboard.Alt_Button_Cycle_Gender]: Button.CYCLE_GENDER,
        [SettingInterfaceKeyboard.Alt_Button_Cycle_Ability]: Button.CYCLE_ABILITY,
        [SettingInterfaceKeyboard.Alt_Button_Cycle_Nature]: Button.CYCLE_NATURE,
        [SettingInterfaceKeyboard.Alt_Button_Cycle_Variant]: Button.CYCLE_VARIANT,
        [SettingInterfaceKeyboard.Alt_Button_Speed_Up]: Button.SPEED_UP,
        [SettingInterfaceKeyboard.Alt_Button_Slow_Down]: Button.SLOW_DOWN,
    },
    default: {
